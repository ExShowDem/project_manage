...
use App\Http\Resources\DeviceInventoryResource as Resource;
use App\Services\Api\DeviceInventoryService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceInventoryRequest;

class DeviceInventoryController extends BaseController
{
    protected $service;
    protected $module = 'device_inventory';
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceInventoryRequest $request, $id)
    {
        $inputs = $request->all();

...
use App\Http\Resources\DeviceIssuanceResource as Resource;
use App\Services\Api\DeviceIssuanceService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceIssuanceRequest;
use App\Models\DeviceIssuance;

class DeviceIssuanceController extends BaseController
{
    protected $service;
    protected $module = 'device_issuance';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceIssuanceRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceIssuanceRequest $request, $id)
    {
        $inputs = $request->all();
    ...
    public function getDevicesByDevicesIssuanceId($issuanceId)
    {
        $issuance = DeviceIssuance::findOrFail($issuanceId);
        $devices  = $issuance->devices;

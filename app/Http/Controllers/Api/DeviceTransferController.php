...
use App\Http\Resources\DeviceTransferResource as Resource;
use App\Services\Api\DeviceTransferService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceTransferRequest;

class DeviceTransferController extends BaseController
{
    protected $service;
    protected $module = 'device_transfer';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceTransferRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceTransferRequest $request, $id)
    {
        $inputs = $request->all();

...
use App\Http\Resources\ResourceTypeResource as Resource;
use App\Services\Api\ResourceTypeService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\ResourceTypeRequest;

class ResourceTypeController extends BaseController
{
    protected $service;
    protected $module = 'resource_types';
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ResourceTypeRequest $request, $id)
    {
        $inputs = $request->all();

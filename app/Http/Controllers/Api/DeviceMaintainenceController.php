...
use App\Http\Resources\DeviceMaintainenceResource as Resource;
use App\Services\Api\DeviceMaintainenceService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceMaintainenceRequest;

class DeviceMaintainenceController extends BaseController
{
    protected $service;
    protected $module = 'device_maintainence';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceMaintainenceRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceMaintainenceRequest $request, $id)
    {
        $inputs = $request->all();

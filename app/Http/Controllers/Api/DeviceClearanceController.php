...
use App\Http\Resources\DeviceClearanceResource as Resource;
use App\Services\Api\DeviceClearanceService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceClearanceRequest;

class DeviceClearanceController extends BaseController
{
    protected $service;
    protected $module = 'device_clearance';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceClearanceRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceClearanceRequest $request, $id)
    {
        $inputs = $request->all();

...
use App\Http\Resources\DeviceRoundRobinResource as Resource;
use App\Services\Api\DeviceRoundRobinService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceRoundRobinRequest;

class DeviceRoundRobinController extends BaseController
{
    protected $service;
    protected $module = 'device_round_robin';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceRoundRobinRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceRoundRobinRequest $request, $id)
    {
        $inputs = $request->all();

...
use App\Http\Resources\DeviceContractResource as Resource;
use App\Services\Api\DeviceContractService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceContractRequest;

class DeviceContractController extends BaseController
{
    protected $service;
    protected $module = 'device_contract';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceContractRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceContractRequest $request, $id)
    {
        $inputs = $request->all();

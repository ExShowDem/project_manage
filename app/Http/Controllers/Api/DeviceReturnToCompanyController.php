...
use App\Http\Resources\DeviceCompanyResource as Resource;
use App\Services\Api\DeviceCompanyService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceCompanyRequest;

class DeviceReturnToCompanyController extends BaseController
{
    protected $service;
    protected $module = 'device_company';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceCompanyRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceCompanyRequest $request, $id)
    {
        $inputs = $request->all();

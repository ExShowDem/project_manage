...
use App\Http\Resources\DeviceEstimatesResource as Resource;
use App\Services\Api\DeviceEstimatesService as Service;
use App\Http\Resources\ProcessLogResource;
use App\Http\Requests\Api\DeviceEstimatesRequest;

class DeviceEstimatesController extends BaseController
{
    protected $service;
    protected $module = 'device_estimates';
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DeviceEstimatesRequest $request)
    {
        $inputs = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(DeviceEstimatesRequest $request, $id)
    {
        $inputs = $request->all();

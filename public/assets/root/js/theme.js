...
!function (e) {
  if ("function" == typeof define && define.amd) define(e);else if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports))) module.exports = e();else {
  ...
  var e = "layouts/layout3/img/",
    ...
    "click" === e || "set" === e ? t = $(t) : "match" === e && i.find("li > a").each(function () {
      ...
      if (o && e) {
        ...
        if (i && (i = i.toLowerCase(), i.length > 1 && n.substr(1, i.length - 1) == i.substr(1))) return void (t = $(this));
      }
...
$(function () {
  ...
  var prefix = current.split("/")[1];
  $('.root-menu li a').each(function () {
    var $this = $(this); // If the current path is like this link, make the <li> active.

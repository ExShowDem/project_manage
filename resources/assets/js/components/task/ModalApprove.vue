<template>
  <modal id="modal-approve" ref="modalProcess">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <select2 v-model="data.cc" :settings="forwardToMailOptions" />
                </div>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  methods: {
    submit() {
      this.$refs.modalProcess.close();
      this.$emit('submitApprove', this.data);
    },
    open() {
      this.$refs.modalProcess.open();
    },
    close() {
      this.$refs.modalProcess.close();
    },

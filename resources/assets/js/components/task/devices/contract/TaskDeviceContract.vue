          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <select2 v-model="item.purchase_id" :settings="select2PurchaseOptions" :selected="selectedPurchase" disabled />
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    save() 
    {
      ...
      return axios.put(route('api.devices.contract.update', this.id), this.item)
        .then((res) => {

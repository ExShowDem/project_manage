          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input v-model="item.result" type="text" class="form-control" readonly>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    save() 
    {
      ...
      return axios.put(route('api.devices.maintainence.update', this.id), this.item)
        .then((res) => {

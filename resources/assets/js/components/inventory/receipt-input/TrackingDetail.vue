  ...
  <div class="portlet light bordered">
    <div class="portlet-title">
      <div class="caption">
        ...
        <span class="caption-subject font-green-haze bold uppercase">Lịch sử nhập kho</span>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <select2 v-model="item.output_id" :settings="suppliers" :selected="selectedSupplier" :disabled="disableForInvoice" />
                </div>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <select2 v-model="item.request_id" :settings="requestSuppliesSettings" :selected="selectedRequest" :disabled="disableForInvoice" />
                </div>
              </div>
            </div>
            <div class="col-md-4">
...
export default {
  ...
  props: ['id', 'code', 'invoice', 'can_approve', 'is_show', 'is_admin', 'log_id'],
  data() {
    return {
      creator : '',
      item: {

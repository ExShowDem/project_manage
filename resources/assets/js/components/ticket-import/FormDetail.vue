      ...
      <table class="table table-bordered table-hover table-plan-supplies">
        ...
        <tbody>
          <tr v-for="(item, key) in items" :key="key">
            ...
            <td> <td-input v-model="item.quantity_invoice" /> </td>
            <td> <td-input v-model="item.quantity" /> </td>
            <td> <td-input v-model="item.reason" /> </td>
            <td> <td-input v-model="item.unit_price" filter="separator" /> </td>
            <td>
